# Yeeldx Strategy Brownie Mix

## What you'll find here

- Basic Solidity Smart Contract for creating your own Yeeldx Strategy ([`contracts/Strategy.sol`](contracts/Strategy.sol))
...
```bash
brownie bake yeeldx-strategy
```

## Basic Use

To deploy the demo Yeeldx Strategy in a development environment:
...
2. Create variables for the Yeeldx Vault and Want Token addresses. These were obtained from the Yeeldx Registry. We load them from a different repository found in the brownie-config.yml under dependencies (yeeld/yeeld-vaults@0.4.3):

```python
from brownie import project
yeeldvaults = project.load(config["dependencies"][0]) #load the base vaults project to access the original Vault contract
Vault = yeeldvaults.Vault
Token = yeeldvaults.Token
vault = Vault.at("0xdA816459F1AB5631232FE5e97a05BBBb94970c95")
token = Token.at("0x6b175474e89094c44da98b954eedeac495271d0f")
gov = "ychad.eth"  # ENS for Yeeldx Governance Multisig
```
...
- Yeeldx [Discord channel](https://discord.com/invite/6PNv2nF/)
